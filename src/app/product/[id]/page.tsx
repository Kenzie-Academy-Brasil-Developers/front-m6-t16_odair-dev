          ...
          <div className={styles.left}>
            ...
            <div className={styles.divDescription}>
              ...
              <a
                ...
                href={`https://wa.me/${announcement.user.phone}`}
                target="_blank"
            ...
            <div className={styles.owner}>
              ...
              <p className={`${styles.name} ${lexend.className}`}>
                {announcement.user.name}
              </p>
              <p className={styles.description}>
                {announcement.user.description}
              </p>
              <button className={styles.btnHome} onClick={() => goAdvertiser()}>
              ...
              {announcement.comment.map((i) => (
                <div className={styles.cardComment} key={i.id}>
                  <div className={styles.headerComment}>
                    <div className={styles.circle}>
                      {i.user.name[0].toLocaleUpperCase()}
                    </div>
            ...
            {user ? (
              <div className={styles.newComment}>
                ...
                <button className={styles.commentDefault}>
                  Recomendar para meus amigos!
                </button>
              </div>
            ) : (
              <div className={styles.newComment}>
                <form>
                  <textarea
                    ...
                    disabled
                  ></textarea>
                  <button className={styles.btnNewCommentDisabled} disabled>
                    Comentar
                  </button>
                </form>
                <button className={styles.commentDefault} disabled>
                  Gostei muito!
                </button>
                <button className={styles.commentDefault} disabled>
                  Incrível
